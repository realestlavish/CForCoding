...
double basicmerge(vector<int> a, vector<int> b)
{
    if (a.size() > b.size())
        return basicmerge(b, a);
...
double bettermerge(vector<int> a, vector<int> b)
{
    if (a.size() > b.size())
        return bettermerge(b, a);
    int n1 = a.size(), n2 = b.size();
    int i = 0, j = 0;
    int cnt = 0;
    int n = n1 + n2;
...
int main()
{
    ...
    // double result1 = basicmerge(arr1, arr2);
    // cout << "Basic merge result: " << result1 << endl;

    double result2 = bettermerge(arr1, arr2);
    cout << " merge result: " << result2 << endl;

    double result3 = binarysearch(arr1, arr2);
